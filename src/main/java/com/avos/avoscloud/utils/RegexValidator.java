 ...
 *
 * <p>
 * Cached instances pre-compile and re-use {@link Pattern}(s) - which according to the
 * {@link Pattern} API are safe to use in a multi-threaded environment.
 * </p>
 *
...
public class RegexValidator implements Serializable {
   ...
   *
   * @param value The value to validate.
   * @return Aggregated String value comprised of the <i>groups</i> matched if valid or
